 ...
 * Size: 20 px
 * Bpp: 4
 * Opts: --bpp 4 --size 20 --no-compress --stride 1 --align 1 --font Font Awesome 6 Free-Solid-900.otf --range 63587 --format lvgl -o fan_20.c
 ******************************************************************************/
...
{
    {
        .range_start = 63587, .range_length = 1, .glyph_id_start = 1,
